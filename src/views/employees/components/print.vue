<template>
  <div id="printMe" class="dashboard-container">
    <div class="app-container">
      <el-card>
        <el-breadcrumb separator="/" class="titInfo ">
          ...
          <!-- <el-breadcrumb-item v-print="'#printMe'">打印</el-breadcrumb-item> -->
          <el-breadcrumb-item v-print="`${type==='personal' ? '#personalRange' : '#jobRange'}`">打印</el-breadcrumb-item>
        </el-breadcrumb>
        <div v-if="type === 'personal'" id="personalRange">
